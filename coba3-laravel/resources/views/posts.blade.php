        ...
        <div class="card-body text-center">
          ...
          <p>
            <small class="text-muted">
                By. <a href="/authors/{{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> <a href="/categories/{{
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    style="background-color: rgba(0, 0, 0, 0.7)"><a href="/categories/{{
                        $post->category->slug }}" 
